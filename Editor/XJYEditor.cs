...
public class XJYEditor : EditorWindow
{
    ...
    static void SelectByTag() {
         GameObject [] gos=   GameObject.FindGameObjectsWithTag(tag );
         Selection.objects = gos;
    }
    [MenuItem("XJY/改名/手动递增改名 %q")]
    static void ChangeNameOneByOne()
    {
    ...
    static void ChangeChidrensEndName()
    {

        ChangeChidrensEndNameFun(Selection.activeGameObject.transform);
    }

    static void RemoveChidrensEndName()
    {
    ...
    static void ChangeChidrensName()
    {
    ...
    static string childNoStr = 0.ToString();
